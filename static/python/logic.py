...
def sign_clicked(args):
    if args.target.id == "equal-to":
       calculate()
        ...
        clear_all()
    elif args.target.id == "percent" and demo_calculator.sign_click == "" and demo_calculator.num_second == "":
    ...
    elif args.target.id == "plus-or-minus" and demo_calculator.num_first != "" and demo_calculator.sign_click == "" and demo_calculator.num_second == "":
...
def change_theme(all_btns, all_btns_num, theme="light"):
    ...
    Element("main").element.style.backgroundColor = "white" if theme == "light" else "#060709"
    Element("theme-buttons").element.style.backgroundColor = "#F9F9F9" if theme == "light" else "#292D36"
    Element("main").element.style.color = "#060709" if theme == "light" else "white"
    Element("btn-wrapper").element.style.backgroundColor = "#F9F9F9" if theme == "light" else "#292D36"
    Element("bottom-line").element.style.backgroundColor = "#DFDEDE" if theme == "light" else "#474B52"
